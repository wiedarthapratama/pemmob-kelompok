...
class _FormPageState extends State<FormPage> {
  ...
  // final stokCtrl = MoneyMaskedTextController(
  // decimalSeparator: '.', thousandSeparator: ','); //after
  // final hargaCtrl = MoneyMaskedTextController(
  //     decimalSeparator: '.', thousandSeparator: ','); //after
              ...
              MaterialButton(
                onPressed: () async {
                  if (namaCtrl.text.isEmpty &&
                    ...
                    // try {
                    int hasil = await apiController.addProduk(namaCtrl.text,
                        jenisCtrl.text, stokCtrl.text, hargaCtrl.text);
                    print(hasil);
                    if (hasil == 200) {
